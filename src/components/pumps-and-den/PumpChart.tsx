...
export default function PumpChart() {
    ...
    return (
        <motion.div
            ...
            className=' container overflow-hidden mx-auto flex flex-col h-full'>
            <Box className='gap-4 lg:grid lg:grid-cols-1 md:grid-cols-3 sm:grid-cols-1 h-full no-scrollbar overflow-auto'>
